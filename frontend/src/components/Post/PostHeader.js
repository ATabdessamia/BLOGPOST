  ...
  return (
    <div className="flex flex-col sm:flex-row items-center">
      ...
      <div className="flex-1 flex justify-between mt-12 sm:mt-0 w-full">
        <div className="p-2">
          <h1 className="font-kufi text-3xl text-gray-700 mb-1">
            العنوان الرئيسي
          </h1>
          <h4 className="text-gray-500 text-lg ">نشر في 2020</h4>
          <h3 className="text-gray-600 font-black text-lg mt-1">
            <span className="ml-2">المؤلف</span>
            <span className="bg-gray-300 rounded-lg px-1">اسم المؤلف</span>
          </h3>
        </div>
